...
export const allModifiersMap = {
  "Weapon Stat": foundry.utils.deepClone(weapon_stats),
  "Armor Stat": foundry.utils.deepClone(armor_stats),
  "Vehicle Stat": foundry.utils.deepClone(vehicle_stats),
  "Stat": character_stats,
  "Result Modifiers": foundry.utils.deepClone(itemmodifier_resultmodifiers),
  "Dice Modifiers": foundry.utils.deepClone(itemmodifier_dicemodifiers),
  "Roll Modifiers": foundry.utils.deepClone(itemmodifier_rollmodifiers),
  "Characteristic": foundry.utils.deepClone(character_characteristics),
  "Career Skill": foundry.utils.deepClone(skills),
  "Force Boost": foundry.utils.deepClone(skills),
  "Skill Add Advantage": foundry.utils.deepClone(skills),
  "Skill Add Dark": foundry.utils.deepClone(skills),
  "Skill Add Despair": foundry.utils.deepClone(skills),
  "Skill Add Failure": foundry.utils.deepClone(skills),
  "Skill Add Light": foundry.utils.deepClone(skills),
  "Skill Add Success": foundry.utils.deepClone(skills),
  "Skill Add Threat": foundry.utils.deepClone(skills),
  "Skill Add Triumph": foundry.utils.deepClone(skills),
  "Skill Add Upgrade": foundry.utils.deepClone(skills),
  "Skill Boost": foundry.utils.deepClone(skills),
  "Skill Rank": foundry.utils.deepClone(skills),
  "Skill Remove Setback": foundry.utils.deepClone(skills),
  "Skill Setback": foundry.utils.deepClone(skills),
}
